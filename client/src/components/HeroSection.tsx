...
import { heroContainer, heroItem, luxuryEase, luxuryTransition, scrollToHash } from "@/lib/motion";
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center py-16 lg:py-24">
          ...
          >
            ...
            <motion.div variants={heroItem} className="flex flex-col sm:flex-row gap-3 mb-10">
              ...
              <a
                href="#how-it-works"
                onClick={(e) => { e.preventDefault(); scrollToHash("#how-it-works"); }}
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ ...luxuryTransition, duration: 0.9, delay: 0.25 }}
          ...
          >
            ...
            <div className="relative z-10 w-72 lg:w-80 xl:w-96">
              ...
              <motion.div
                ...
                transition={{ delay: 1.2, duration: 0.7, ease: luxuryEase }}
              ...
              <motion.div
                initial={{ opacity: 0, y: 8 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 1.8, duration: 0.7, ease: luxuryEase }}
